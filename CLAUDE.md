...
4. **Update dependencies** → Modify both `requirements.txt` and `Pipfile` → Rebuild Docker container
...
- **Dependencies**: Use either pip or pipenv consistently to avoid conflicts
...
### Modernization (2025)
- **Python**: Upgraded from 3.9 to 3.12 (3.13 for pipenv)
